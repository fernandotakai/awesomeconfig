...
naughty.config.defaults.on_top = false
naughty.config.defaults.width = 380
...
function set_wallpaper()
    wallpapers_path = "/home/ftakai/Pictures/simplewallpaper/"
    local files = scandir(wallpapers_path)

    for s = 1, screen.count() do
        wallpaper = files[math.random(#files)]
        gears.wallpaper.maximized(wallpapers_path .. wallpaper, s, true)
    end
end
...
--for s = 1, screen.count() do
    --gears.wallpaper.maximized("/home/ftakai/Pictures/space_needle_down_crop.jpg", s, false)
--end
...
vicious.register(mynetwidget, vicious.widgets.net, 
                '<span color="#CC9393">${wlp2s0 down_kb}</span> <span color="#7F9F7F">${wlp2s0 up_kb}</span>', 3)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -q set Master 500+ unmute") end),
    awful.key({}, "XF86AudioLowerVolume", function () awful.util.spawn("amixer -q set Master 500- unmute")end),
    awful.key({}, "XF86AudioMute", function () awful.util.spawn("amixer -q set Master toggle") end),
    awful.key({}, "XF86MonBrightnessDown", function () awful.util.spawn("xbacklight -dec 5") end),
    awful.key({}, "XF86MonBrightnessUp", function () awful.util.spawn("xbacklight -inc 10") end),
    awful.key({ modkey }, "Print", function () set_wallpaper() end),
